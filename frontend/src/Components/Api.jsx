...
const Api = () => {
    ...
    const getJson = e => {
        ...
        axios.get(endPoint).then(resp => {
            ...
            if (err.response) {
                setOutput(`Unable to find JSON of ID ${endPoint.split("/").pop()}`)
            } else if (err.request) {
                ...
                <Col>
                    <Card className="text-center">
                        ...
                        <Card.Body className="text-left">
                            <Form>
                                <Form.Row>
                                    <Form.Label column="lg" xs="auto">Endpoint:</Form.Label>
                                    <Col xs={true}>
                                        <Form.Control size="lg" type="text" value={endPoint}
